...
| Android | IsoDep adapter and AAR packaging for ARM64, ARMv7 and x86_64 JNI/C/C++ runtimes | Current commit evidence: all three ABI cross-build/export/dependency checks, 16 KiB ARM64/x86_64 ELF alignment, release lint, Android-test/example compilation, AAR hashes, and APK native/hash/ZIP-alignment verification | Package evidence is recorded; hosted emulator and physical-NFC execution remain pending, and API 23/ARMv7 runtime remain unqualified |
