...
| Android | IsoDep adapter and AAR packaging for ARM64, ARMv7 and x86_64 JNI/C/C++ runtimes | Required current-commit evidence: all three ABI cross-build/export/dependency checks, 16 KiB ARM64/x86_64 ELF alignment, release lint, Android-test/example compilation, AAR hashes, and APK native/hash/ZIP-alignment verification | No current-revision package, emulator, or physical-NFC result is recorded; API 23 and ARMv7 runtime remain unqualified |
